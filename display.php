       ...
       <?php
        ...
        while($geetika=mysqli_fetch_array($z))
        {
            ...
            $msg=$geetika["message"];
             ...
             echo "&nbsp;&nbsp;<a href='update_record.php?id=$id&name=$nm&branch=$brnch&message=$msg&roll=$rll' onclick='return confirm(\"are you sure you want to Update this Record\")'; class='btn btn-warning'>Update</a>";
             echo "</td>";
             echo "</tr>";
        }
